...
export default function NarrativeSection() {
  ...
  return (
    <div ref={containerRef} className="overflow-hidden">
      ...
      {/* The Giant Marquee replace the old plain text header */}
      <Marquee />

      {/* Section 1: The Insight */}
      <section id="the-pattern" className="py-24 px-6 md:px-12 bg-forest-800 relative">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1px] h-32 bg-gradient-to-b from-copper/0 via-copper/50 to-copper/0 hidden md:block"></div>
        <div className="max-w-[720px] mx-auto text-center relative z-10 pt-12">
          ...
          <blockquote className="gsap-fade-up font-serif italic text-4xl md:text-5xl text-paper max-w-[640px] mx-auto my-16 leading-tight drop-shadow-lg shadow-black">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center relative z-10">
          <div className="lg:col-span-5">
            <div className="inline-flex items-center gap-3 mb-8 gsap-fade-up">
              <span className="w-8 h-[1px] bg-copper"></span>
            ...
            <h2 className="gsap-fade-up font-display font-bold text-5xl md:text-6xl text-paper leading-[1.1] drop-shadow-md">
              The same issues<br/>keep coming <span className="text-transparent bg-clip-text bg-gradient-to-r from-copper to-copper-light">back.</span>
            </h2>
          </div>
          <div className="lg:col-span-6 lg:col-start-7 glass-panel p-10 md:p-14 relative overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/5 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 transform -translate-x-full group-hover:translate-x-full"></div>
